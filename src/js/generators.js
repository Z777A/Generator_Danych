...
class PolishDataGenerator {
  ...
  generatePesel(isMale = true) {
    ...
    // Losowy numer seryjny (4 cyfry)
    pesel += this.generateRandomDigits(4);
  ...
  generateRandomBirthDate() {
    ...
    const day = Math.floor(Math.random() * 28) + 1; // Uproszczenie - max 28 dni w miesiącu
